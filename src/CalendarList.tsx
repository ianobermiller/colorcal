        ...
        <div class="">
          ...
          <For each={calendars()}>
            {(cal) => (
              ...
              >
                <h3 class="text-gray-900 lg:p-4 lg:pl-8 lg:text-left dark:text-gray-200">{cal.title}</h3>
                ...
                <div class="hidden lg:block lg:p-4 lg:pl-8 lg:text-right">{formatDate(new Date(cal.updatedAt))}</div>
              </a>
            )}
          </For>
        </div>
